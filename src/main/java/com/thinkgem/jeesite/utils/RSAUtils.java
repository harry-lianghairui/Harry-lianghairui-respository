...
public class RSAUtils {
    ...
    public static String loadPublicKeyByFile(boolean online) {
        try {
            ...
            br.close();
            System.out.println("kkkkkkkkkk:        " + sb.toString());
            return sb.toString();
        } catch (Exception e) {
            log.error("load public key error", e);
            throw new GZException(Consts.Code.SECURE_ERROR, null);
        }
    }
    ...
    public static String encrypt(String toBeEncrypt, boolean online) {
        ...
        RSAPublicKey publicKey = RSAUtils.loadPublicKeyByStr(RSAUtils.loadPublicKeyByFile(online));
        if (publicKey == null) {
            throw new GZException(Consts.Code.SECURE_ERROR, null);
        }
        Cipher cipher = null;
    ...
    public static String decrypt(String cipherData, boolean online) {
        ...
        RSAPrivateKey privateKey = RSAUtils.loadPrivateKeyByStr(RSAUtils.loadPrivateKeyByFile(online));
        if (privateKey == null) {
            return null;
        }
        Cipher cipher = null;
        try {
            ...
            log.error("decrypt error cipherData:{},online:{}", cipherData, online, e);
        }
        return null;
    }
